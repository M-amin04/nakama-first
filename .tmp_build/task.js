...
exports.buyItemRpc = exports.setActiveItemRpc = exports.getInventoryRpc = exports.getShopItemsRpc = exports.afterAuthenticateDevice = void 0;
...
exports.getShopItemsRpc = getShopItemsRpc;
...
exports.getInventoryRpc = getInventoryRpc;
const setActiveItemRpc = function (ctx, logger, nk, payload) {
    const { userId, input } = validateAndParse(ctx, payload);
...
exports.setActiveItemRpc = setActiveItemRpc;
